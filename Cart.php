...
<body>
                        ...
                        <div class="col-xl-5 col-lg-5 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-xl-block" style="margin-right: 1px">
                                    <a class="towHomeBtn" href="User_Home.html">MyAccount</a>
                                </div>
                                <div class="book_btn d-none d-xl-block">
                                    <a class="towHomeBtn" href="login.html">Log Out</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <!-- end content -->   
            ...
            <div class="buttons"  style="margin-bottom: 70px">
                <div class="pull-left"><a class="btn btn-primary reg_button" style="margin-left: 140px;background-color: #F54300" href="menu.html"><i class="fa fa-caret-right"></i>&nbsp;Continue Shopping</a></div>
                <div class="pull-right"><a class="btn btn-primary reg_button" style="margin-right: 100px;background-color: #F54300" href="checkout.html">Confirm & Checkout</a></div>
            </div>
</div>
                        ...
                        <div class="col-xl-4 col-md-12 col-lg-4">
                                <div class="footer_widget">
                                        ...
                                        <form action="#" class="newsletter_form">
                                            <button type="submit"><a href="Register.html" style="font-family: 'East Sea Dokdo'">Register Now</a></button>
                                        </form>
