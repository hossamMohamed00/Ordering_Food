    ...
    <div class="panel panel-default" >
        ...
        <div id="collapse-shipping-address" class="panel-collapse collapse in" aria-expanded="true" style="margin-top: 25px">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="ThanksPage.html" method="post" enctype="multipart/form-data">
                    ...
                    <form class="form-horizontal" action="Cart.html" method="post" enctype="multipart/form-data">
                        <div class="form-group">        
                          <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <div class="col-xl-4 col-md-12 col-lg-4">
                                <div class="footer_widget">
                                        ...
                                        <form action="#" class="newsletter_form">
                                            <button type="submit" style="font-family: 'East Sea Dokdo'"><a href="Register.html">Register Now</a></button>
                                        </form>
